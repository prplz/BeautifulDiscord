...
"""
    ...
    parser.add_argument('--frame', action='store_true', help="Patch discord to show the operating system's window frame")
...
def main():
    ...
    if args.frame:
        to_write = to_write.replace(b'frame: false', b'frame: true', 1)
